...
const ExcessAirtime = () => {
  ...
  const plans = [
    { key: "Plan1", value: "MTN 500GMB" },
    { key: "Plan2", value: "MTN 1GB" },
    { key: "Plan3", value: "MTN 3GB" },
    { key: "Plan4", value: "MTN 5GB" },
    { key: "Plan5", value: "MTN 10GB" },
  ];
    ...
    >
      ...
      >
        <View>
          ...
          <View style={{ marginTop: 20 }}>
            <Text style={{ fontFamily: "Outfit-Regular", fontSize: 16 }}>
              Phone Number You're sending From
            </Text>
            <View
              style={{
                borderWidth: 1,
            ...
            >
              <TextInput
                style={{ padding: 5 }}
                placeholder="Phone Number You're sending From"
